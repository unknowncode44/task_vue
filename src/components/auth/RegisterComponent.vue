...
<template>
    ...
    <form @submit.prevent class="p-6 space-y-4 md:space-y-6 sm:p-8" action="#">
        <div>
        ...
        <div class="my-4"></div>
        <button type="submit" :class="theme.isDark ? 'hover:bg-blue-700 focus:ring-blue-800 bg-blue-600' : 'hover:bg-blue-700'" class="w-full text-white bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded text-sm px-5 py-3 text-center">Create an account</button>
    </form>
</template>
